...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * System.out.println("Charles Bronson : " + auth.login("cbronson",
		 * "Metrallet@1")); System.out.println("David Carradine : " +
		 * auth.login("dcarradine", "kungfu")); System.out.println("David Carradine : "
		 * + auth.login("dcarradine", "karate"));
